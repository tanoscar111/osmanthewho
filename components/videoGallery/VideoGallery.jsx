			...
			<div className="video-gallery-container">
				...
				<div className="video">
					<Link href="/work">
						<a>
							<div className='video-thumbnail px-480-270'>
								<video autoPlay="autoplay" loop src="https://media.giphy.com/media/5rvbjla0ic8y85KAZV/giphy.mp4" />
							</div>
						</a>
					</Link>
				</div>
				...
				<div className="video">
					<Link href="/work">
						<a>
							<div className='video-thumbnail px-480-270'>
								<video autoPlay="autoplay" loop src="https://media.giphy.com/media/vlAFEr3HFGf9nsW43S/giphy.mp4" />
							</div>
						</a>
					</Link>
				</div>
				...
				<div className="video">
					<Link href="/work">
						<a>
							<div className='video-thumbnail px-440-550'>
								<video autoPlay="autoplay" loop src="https://media.giphy.com/media/r8yEoWu6JSp6W5R438/giphy.mp4" />
							</div>
						</a>
					</Link>
				</div>
				...
				<div className="video">
					<Link href="/work">
						<a>
							<div className='video-thumbnail px-440-550'>
								<video autoPlay="autoplay" loop src="https://media.giphy.com/media/QYtmJAkR8STjJ6kmeM/giphy.mp4" />
							</div>
						</a>
					</Link>
				</div>
...
{/*
				...
				<div className="video">
					<Link href="/work">
						<a>
							<div className='video-thumbnail px-480-270'>
								<video autoPlay="autoplay" loop src="https://media.giphy.com/media/ovN710as1hM9lmE4fA/giphy.mp4" />
							</div>
						</a>
					</Link>
				</div>
					...
					<Link href="/work">
						<a>
							<div className='video-thumbnail px-384-480'>
								<video autoPlay="autoplay" loop src="https://media.giphy.com/media/7Sw0vVD2Nj2MXNO2cB/giphy.mp4" />
							</div>
						</a>
					</Link>
				</div>
